...
def sim_func(obs, sim_conf):
    ...
    gem5_sim_res = run_gem5_sim(obs, sim_conf)
...
class evaluation_gem5:
    ...
    def eval(self, obs_in):
        print("Current design point is :", obs_in)
...
if __name__=='__main__':
    ...
    eval = evaluation_gem5(default_obs)
    eval.eval(default_obs.values())
    eval.print_eval_res()
